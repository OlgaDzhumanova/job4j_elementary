...
public class MathCalculator {
    ...
    public static double sumMethodsMathFunction(double first, double second) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Результат расчета sumMethodsMathFunction равен: " + sumMethodsMathFunction(10, 20));
    }
